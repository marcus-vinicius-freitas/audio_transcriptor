...
class VideoEdit:
    ...
    def sub_clip(self, video, start, end, output, to_full_duration=False, offset=10):
        if to_full_duration:
            ...
            while start <= duration:
                ...
                ffmpeg_extract_subclip(r"{}".format(video), start, start + interval, targetname=output_file_name)
